<x-app-layout>
        ...
        <table class="w-full border-collapse">
          <thead class="bg-[#f4f4f4]">
            <tr>
              ...
              <th class="p-4 text-left border-b border-gray-300 font-medium">{{ __('Created at') }}</th>
          ...
          <tbody>
            ...
            <tr>
              <td class="p-4 text-left border-b border-gray-300 font-medium">{{ $admin->name }}</td>
              <td class="p-4 text-left border-b border-gray-300 font-medium">{{ $admin->last_name }}</td>
              <td class="p-4 text-left border-b border-gray-300 font-medium">{{ $admin->middle_name }}</td>
              <td class="p-4 text-left border-b border-gray-300 font-medium">{{ $admin->email }}</td>
              <td class="p-4 text-left border-b border-gray-300 font-medium">{{ $admin->created_at->format('d/m/Y') }}</td>
              <td class="p-4 text-left border-b border-gray-300 font-medium"><span class="status px-2.5 py-1.5 rounded-full text-white text-[0.9em] {{ $admin->status }}">{{ __($admin->status) }}</span></td>
              <td class="p-4 text-left border-b border-gray-300 font-medium">
                <div class="flex items-center gap-2.5">
                  ...
                  @php
                  $deleteRoute = route('admin.delete', ['id' => $admin->id]);
                  @endphp
  ...
  <div id="createUserModal" class="hidden fixed top-0 left-0 w-full h-full justify-center items-center" style="background: rgba(0, 0, 0, 0.5);">
    <div class="bg-white p-5 rounded-lg w-[500px] max-w-[90%]">
      <h3 class="text-lg font-semibold mb-4">{{ __('Create admin') }}</h3>
  ...
  <div id="editUserModal" class="hidden fixed top-0 left-0 w-full h-full justify-center items-center" style="background: rgba(0, 0, 0, 0.5);">
    <div class="bg-white p-5 rounded-lg w-[500px] max-w-[90%]">
